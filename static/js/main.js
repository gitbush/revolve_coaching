...
let ppCountDownDate = new Date("June 15, 2022 20:00:00").getTime();
...
function setWhichDate(){
  ...
  else if(whichTimer.classList.contains("ppw")){
    theDate = ppCountDownDate
  }
  return theDate
...
let timerDiv = document.getElementById("timer-days")
if(timerDiv){
